...
func (q Query) HostEq(v string) Query              { return q.Where(Host.Eq(v)) }
func (q Query) HostNotEq(v string) Query           { return q.Where(Host.NotEq(v)) }
func (q Query) HostGt(v string) Query              { return q.Where(Host.Gt(v)) }
func (q Query) HostGte(v string) Query             { return q.Where(Host.Gte(v)) }
func (q Query) HostLt(v string) Query              { return q.Where(Host.Lt(v)) }
func (q Query) HostLte(v string) Query             { return q.Where(Host.Lte(v)) }
func (q Query) HostLike(v string) Query            { return q.Where(Host.Like(v)) }
func (q Query) HostILike(v string) Query           { return q.Where(Host.ILike(v)) }
func (q Query) HostIn(v ...string) Query           { return q.Where(Host.In(v...)) }
func (q Query) HostNotIn(v ...string) Query        { return q.Where(Host.NotIn(v...)) }
func (q Query) FingerprintEq(v string) Query       { return q.Where(Fingerprint.Eq(v)) }
func (q Query) FingerprintNotEq(v string) Query    { return q.Where(Fingerprint.NotEq(v)) }
func (q Query) FingerprintGt(v string) Query       { return q.Where(Fingerprint.Gt(v)) }
func (q Query) FingerprintGte(v string) Query      { return q.Where(Fingerprint.Gte(v)) }
func (q Query) FingerprintLt(v string) Query       { return q.Where(Fingerprint.Lt(v)) }
func (q Query) FingerprintLte(v string) Query      { return q.Where(Fingerprint.Lte(v)) }
func (q Query) FingerprintLike(v string) Query     { return q.Where(Fingerprint.Like(v)) }
func (q Query) FingerprintILike(v string) Query    { return q.Where(Fingerprint.ILike(v)) }
func (q Query) FingerprintIn(v ...string) Query    { return q.Where(Fingerprint.In(v...)) }
func (q Query) FingerprintNotIn(v ...string) Query { return q.Where(Fingerprint.NotIn(v...)) }
func (q Query) KeyTypeEq(v string) Query           { return q.Where(KeyType.Eq(v)) }
func (q Query) KeyTypeNotEq(v string) Query        { return q.Where(KeyType.NotEq(v)) }
func (q Query) KeyTypeGt(v string) Query           { return q.Where(KeyType.Gt(v)) }
func (q Query) KeyTypeGte(v string) Query          { return q.Where(KeyType.Gte(v)) }
func (q Query) KeyTypeLt(v string) Query           { return q.Where(KeyType.Lt(v)) }
func (q Query) KeyTypeLte(v string) Query          { return q.Where(KeyType.Lte(v)) }
func (q Query) KeyTypeLike(v string) Query         { return q.Where(KeyType.Like(v)) }
func (q Query) KeyTypeILike(v string) Query        { return q.Where(KeyType.ILike(v)) }
func (q Query) KeyTypeIn(v ...string) Query        { return q.Where(KeyType.In(v...)) }
func (q Query) KeyTypeNotIn(v ...string) Query     { return q.Where(KeyType.NotIn(v...)) }
func (q Query) PinnedAtEq(v time.Time) Query       { return q.Where(PinnedAt.Eq(v)) }
func (q Query) PinnedAtNotEq(v time.Time) Query    { return q.Where(PinnedAt.NotEq(v)) }
func (q Query) PinnedAtGt(v time.Time) Query       { return q.Where(PinnedAt.Gt(v)) }
func (q Query) PinnedAtGte(v time.Time) Query      { return q.Where(PinnedAt.Gte(v)) }
func (q Query) PinnedAtLt(v time.Time) Query       { return q.Where(PinnedAt.Lt(v)) }
func (q Query) PinnedAtLte(v time.Time) Query      { return q.Where(PinnedAt.Lte(v)) }
func (q Query) PinnedByEq(v string) Query          { return q.Where(PinnedBy.Eq(v)) }
func (q Query) PinnedByNotEq(v string) Query       { return q.Where(PinnedBy.NotEq(v)) }
func (q Query) PinnedByGt(v string) Query          { return q.Where(PinnedBy.Gt(v)) }
func (q Query) PinnedByGte(v string) Query         { return q.Where(PinnedBy.Gte(v)) }
func (q Query) PinnedByLt(v string) Query          { return q.Where(PinnedBy.Lt(v)) }
func (q Query) PinnedByLte(v string) Query         { return q.Where(PinnedBy.Lte(v)) }
func (q Query) PinnedByLike(v string) Query        { return q.Where(PinnedBy.Like(v)) }
func (q Query) PinnedByILike(v string) Query       { return q.Where(PinnedBy.ILike(v)) }
func (q Query) PinnedByIn(v ...string) Query       { return q.Where(PinnedBy.In(v...)) }
func (q Query) PinnedByNotIn(v ...string) Query    { return q.Where(PinnedBy.NotIn(v...)) }

const selectPrefix = `SELECT "host", "fingerprint", "key_type", "pinned_at", "pinned_by" FROM "host_key_pins"`
const countPrefix = `SELECT count(*) FROM "host_key_pins"`
const existsPrefix = `SELECT 1 FROM "host_key_pins"`
...
var orderTable = [nCols][4]string{
	{ // host
		"\"host\"",
		"\"host\" DESC",
		"\"host\" ASC NULLS FIRST",
		"\"host\" DESC NULLS LAST",
	},
	{ // fingerprint
		"\"fingerprint\"",
		"\"fingerprint\" DESC",
		"\"fingerprint\" ASC NULLS FIRST",
		"\"fingerprint\" DESC NULLS LAST",
	},
	{ // key_type
		"\"key_type\"",
		"\"key_type\" DESC",
		"\"key_type\" ASC NULLS FIRST",
		"\"key_type\" DESC NULLS LAST",
	},
	{ // pinned_at
		"\"pinned_at\"",
		"\"pinned_at\" DESC",
		"\"pinned_at\" ASC NULLS FIRST",
		"\"pinned_at\" DESC NULLS LAST",
	},
	{ // pinned_by
		"\"pinned_by\"",
		"\"pinned_by\" DESC",
		"\"pinned_by\" ASC NULLS FIRST",
		"\"pinned_by\" DESC NULLS LAST",
	},
}
...
var fragTable = [5][27]runtime.Frag{
	{ // host
		{}, // opNone
		{A: "\"host\" = $", B: ""},
		{A: "\"host\" <> $", B: ""},
	...
	{ // fingerprint
		...
		{A: "\"fingerprint\" < $", B: ""},
		{A: "\"fingerprint\" <= $", B: ""},
		{A: "\"fingerprint\" LIKE $", B: ""},
		{A: "\"fingerprint\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
...
var defaultOrder = [1]runtime.Tok{
	runtime.MakeOrder(runtime.Asc, 0), // host
}
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	r.Host = sl.Str(rv[0])
	r.Fingerprint = sl.Str(rv[1])
	r.KeyType = sl.Str(rv[2])
	r.PinnedAt = runtime.Timestamptz(rv[3])
	r.PinnedBy = sl.Str(rv[4])
	return nil
}
...
// No write API: table host_key_pins has no primary key, so no statement can
