...
type Row struct {
	...
	CreatedAt     time.Time
	PasswordHash  runtime.Null[string]
	TotpSecret    runtime.Null[string]
	MfaEnrolledAt runtime.Null[time.Time]
...
func (q Query) LastSeenAtIsNull() Query              { return q.Where(LastSeenAt.IsNull()) }
func (q Query) LastSeenAtIsNotNull() Query           { return q.Where(LastSeenAt.IsNotNull()) }
...
func (q Query) PasswordHashIsNull() Query            { return q.Where(PasswordHash.IsNull()) }
func (q Query) PasswordHashIsNotNull() Query         { return q.Where(PasswordHash.IsNotNull()) }
func (q Query) TotpSecretEq(v string) Query          { return q.Where(TotpSecret.Eq(v)) }
func (q Query) TotpSecretNotEq(v string) Query       { return q.Where(TotpSecret.NotEq(v)) }
func (q Query) TotpSecretGt(v string) Query          { return q.Where(TotpSecret.Gt(v)) }
func (q Query) TotpSecretGte(v string) Query         { return q.Where(TotpSecret.Gte(v)) }
func (q Query) TotpSecretLt(v string) Query          { return q.Where(TotpSecret.Lt(v)) }
func (q Query) TotpSecretLte(v string) Query         { return q.Where(TotpSecret.Lte(v)) }
func (q Query) TotpSecretLike(v string) Query        { return q.Where(TotpSecret.Like(v)) }
func (q Query) TotpSecretILike(v string) Query       { return q.Where(TotpSecret.ILike(v)) }
func (q Query) TotpSecretIn(v ...string) Query       { return q.Where(TotpSecret.In(v...)) }
func (q Query) TotpSecretNotIn(v ...string) Query    { return q.Where(TotpSecret.NotIn(v...)) }
func (q Query) TotpSecretIsNull() Query              { return q.Where(TotpSecret.IsNull()) }
func (q Query) TotpSecretIsNotNull() Query           { return q.Where(TotpSecret.IsNotNull()) }
func (q Query) MfaEnrolledAtEq(v time.Time) Query    { return q.Where(MfaEnrolledAt.Eq(v)) }
func (q Query) MfaEnrolledAtNotEq(v time.Time) Query { return q.Where(MfaEnrolledAt.NotEq(v)) }
func (q Query) MfaEnrolledAtGt(v time.Time) Query    { return q.Where(MfaEnrolledAt.Gt(v)) }
func (q Query) MfaEnrolledAtGte(v time.Time) Query   { return q.Where(MfaEnrolledAt.Gte(v)) }
func (q Query) MfaEnrolledAtLt(v time.Time) Query    { return q.Where(MfaEnrolledAt.Lt(v)) }
func (q Query) MfaEnrolledAtLte(v time.Time) Query   { return q.Where(MfaEnrolledAt.Lte(v)) }
func (q Query) MfaEnrolledAtIsNull() Query           { return q.Where(MfaEnrolledAt.IsNull()) }
func (q Query) MfaEnrolledAtIsNotNull() Query        { return q.Where(MfaEnrolledAt.IsNotNull()) }
func (q Query) DisabledAtEq(v time.Time) Query       { return q.Where(DisabledAt.Eq(v)) }
func (q Query) DisabledAtNotEq(v time.Time) Query    { return q.Where(DisabledAt.NotEq(v)) }
func (q Query) DisabledAtGt(v time.Time) Query       { return q.Where(DisabledAt.Gt(v)) }
func (q Query) DisabledAtGte(v time.Time) Query      { return q.Where(DisabledAt.Gte(v)) }
func (q Query) DisabledAtLt(v time.Time) Query       { return q.Where(DisabledAt.Lt(v)) }
func (q Query) DisabledAtLte(v time.Time) Query      { return q.Where(DisabledAt.Lte(v)) }
...
var orderTable = [nCols][4]string{
	...
	{ // mfa_enrolled
		"\"mfa_enrolled\"",
		"\"mfa_enrolled\" DESC",
		"\"mfa_enrolled\" ASC NULLS FIRST",
		"\"mfa_enrolled\" DESC NULLS LAST",
	},
	{ // last_seen_at
		"\"last_seen_at\"",
		"\"last_seen_at\" DESC",
	...
	{ // totp_secret
		"\"totp_secret\"",
		"\"totp_secret\" DESC",
		"\"totp_secret\" ASC NULLS FIRST",
		"\"totp_secret\" DESC NULLS LAST",
	},
	{ // mfa_enrolled_at
		"\"mfa_enrolled_at\"",
		"\"mfa_enrolled_at\" DESC",
		"\"mfa_enrolled_at\" ASC NULLS FIRST",
		"\"mfa_enrolled_at\" DESC NULLS LAST",
	},
	{ // disabled_at
		"\"disabled_at\"",
		"\"disabled_at\" DESC",
		"\"disabled_at\" ASC NULLS FIRST",
		"\"disabled_at\" DESC NULLS LAST",
	},
}
...
var fragTable = [11][27]runtime.Frag{
	...
	{ // last_seen_at
		...
		{},
		{},
		{A: "\"last_seen_at\" IS NULL", B: ""},
		{A: "\"last_seen_at\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // created_at
	...
	{ // password_hash
		...
		{},
		{},
		{A: "\"password_hash\" IS NULL", B: ""},
		{A: "\"password_hash\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // totp_secret
		...
		{A: "\"totp_secret\" < $", B: ""},
		{A: "\"totp_secret\" <= $", B: ""},
		{A: "\"totp_secret\" LIKE $", B: ""},
		{A: "\"totp_secret\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		...
		{},
		{},
		{A: "\"totp_secret\" IS NULL", B: ""},
		{A: "\"totp_secret\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // mfa_enrolled_at
		...
		{},
		{},
		{A: "\"mfa_enrolled_at\" IS NULL", B: ""},
		{A: "\"mfa_enrolled_at\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // disabled_at
		...
		{},
		{},
		{A: "\"disabled_at\" IS NULL", B: ""},
		{A: "\"disabled_at\" IS NOT NULL", B: ""},
		{},
		{},
	},
}
...
func (q Query) bindPreds(b *binder) []any {
	v := b.vals[:0]
	var ns, nr, ntm, nbo, nar, nas uint8
...
var setFrags = [nUpdatable]runtime.Frag{
	...
	{A: "\"mfa_enrolled_at\" = $", B: ""}, // mfa_enrolled_at
...
func (m *Mut) SetMfaEnrolled(v bool) {
	m.row.MfaEnrolled = v
	m.dirty |= dMfaEnrolled
}

func (m *Mut) SetLastSeenAt(v time.Time) {
	m.row.LastSeenAt = runtime.Null[time.Time]{V: v, Valid: true}
	m.dirty |= dLastSeenAt
}

// SetLastSeenAtNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetLastSeenAtNull() {
	m.row.LastSeenAt = runtime.Null[time.Time]{}
	m.dirty |= dLastSeenAt
}
...
func (m *Mut) SetPasswordHash(v string) {
	m.row.PasswordHash = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dPasswordHash
}

// SetPasswordHashNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetPasswordHashNull() {
	m.row.PasswordHash = runtime.Null[string]{}
	m.dirty |= dPasswordHash
}

func (m *Mut) SetTotpSecret(v string) {
	m.row.TotpSecret = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dTotpSecret
}

// SetTotpSecretNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetTotpSecretNull() {
	m.row.TotpSecret = runtime.Null[string]{}
	m.dirty |= dTotpSecret
}

func (m *Mut) SetMfaEnrolledAt(v time.Time) {
	m.row.MfaEnrolledAt = runtime.Null[time.Time]{V: v, Valid: true}
	m.dirty |= dMfaEnrolledAt
}

// SetMfaEnrolledAtNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetMfaEnrolledAtNull() {
	m.row.MfaEnrolledAt = runtime.Null[time.Time]{}
	m.dirty |= dMfaEnrolledAt
}

func (m *Mut) SetDisabledAt(v time.Time) {
	m.row.DisabledAt = runtime.Null[time.Time]{V: v, Valid: true}
	m.dirty |= dDisabledAt
}

// SetDisabledAtNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetDisabledAtNull() {
	m.row.DisabledAt = runtime.Null[time.Time]{}
	m.dirty |= dDisabledAt
}
...
func (n *Ins) SetLastSeenAt(v time.Time) {
	n.row.LastSeenAt = runtime.Null[time.Time]{V: v, Valid: true}
	n.set |= iLastSeenAt
}

// SetLastSeenAtNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetLastSeenAtNull() {
	n.row.LastSeenAt = runtime.Null[time.Time]{}
	n.set |= iLastSeenAt
}
...
func (n *Ins) SetPasswordHash(v string) {
	n.row.PasswordHash = runtime.Null[string]{V: v, Valid: true}
	n.set |= iPasswordHash
}

// SetPasswordHashNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetPasswordHashNull() {
	n.row.PasswordHash = runtime.Null[string]{}
	n.set |= iPasswordHash
}

func (n *Ins) SetTotpSecret(v string) {
	n.row.TotpSecret = runtime.Null[string]{V: v, Valid: true}
	n.set |= iTotpSecret
}

// SetTotpSecretNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetTotpSecretNull() {
	n.row.TotpSecret = runtime.Null[string]{}
	n.set |= iTotpSecret
}

func (n *Ins) SetMfaEnrolledAt(v time.Time) {
	n.row.MfaEnrolledAt = runtime.Null[time.Time]{V: v, Valid: true}
	n.set |= iMfaEnrolledAt
}

// SetMfaEnrolledAtNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetMfaEnrolledAtNull() {
	n.row.MfaEnrolledAt = runtime.Null[time.Time]{}
	n.set |= iMfaEnrolledAt
}

func (n *Ins) SetDisabledAt(v time.Time) {
	n.row.DisabledAt = runtime.Null[time.Time]{V: v, Valid: true}
	n.set |= iDisabledAt
}

// SetDisabledAtNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetDisabledAtNull() {
	n.row.DisabledAt = runtime.Null[time.Time]{}
	n.set |= iDisabledAt
}
...
var assignFor = map[string]string{
	...
	"totp_secret":     "\"totp_secret\" = EXCLUDED.\"totp_secret\"",
	"mfa_enrolled_at": "\"mfa_enrolled_at\" = EXCLUDED.\"mfa_enrolled_at\"",
	"disabled_at":     "\"disabled_at\" = EXCLUDED.\"disabled_at\"",
}
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.PasswordHash.Arg())
	args = append(args, r.TotpSecret.Arg())
	args = append(args, r.MfaEnrolledAt.Arg())
	args = append(args, r.DisabledAt.Arg())
