...
func (q Query) CodeHashEq(v string) Query        { return q.Where(CodeHash.Eq(v)) }
func (q Query) CodeHashNotEq(v string) Query     { return q.Where(CodeHash.NotEq(v)) }
func (q Query) CodeHashGt(v string) Query        { return q.Where(CodeHash.Gt(v)) }
func (q Query) CodeHashGte(v string) Query       { return q.Where(CodeHash.Gte(v)) }
func (q Query) CodeHashLt(v string) Query        { return q.Where(CodeHash.Lt(v)) }
func (q Query) CodeHashLte(v string) Query       { return q.Where(CodeHash.Lte(v)) }
func (q Query) CodeHashLike(v string) Query      { return q.Where(CodeHash.Like(v)) }
func (q Query) CodeHashILike(v string) Query     { return q.Where(CodeHash.ILike(v)) }
func (q Query) CodeHashIn(v ...string) Query     { return q.Where(CodeHash.In(v...)) }
func (q Query) CodeHashNotIn(v ...string) Query  { return q.Where(CodeHash.NotIn(v...)) }
...
func (q Query) UsedAtEq(v time.Time) Query       { return q.Where(UsedAt.Eq(v)) }
func (q Query) UsedAtNotEq(v time.Time) Query    { return q.Where(UsedAt.NotEq(v)) }
func (q Query) UsedAtGt(v time.Time) Query       { return q.Where(UsedAt.Gt(v)) }
func (q Query) UsedAtGte(v time.Time) Query      { return q.Where(UsedAt.Gte(v)) }
func (q Query) UsedAtLt(v time.Time) Query       { return q.Where(UsedAt.Lt(v)) }
func (q Query) UsedAtLte(v time.Time) Query      { return q.Where(UsedAt.Lte(v)) }
func (q Query) UsedAtIsNull() Query              { return q.Where(UsedAt.IsNull()) }
func (q Query) UsedAtIsNotNull() Query           { return q.Where(UsedAt.IsNotNull()) }

const selectPrefix = `SELECT "user_id", "code_hash", "created_at", "used_at" FROM "recovery_codes"`
const countPrefix = `SELECT count(*) FROM "recovery_codes"`
const existsPrefix = `SELECT 1 FROM "recovery_codes"`
...
var orderTable = [nCols][4]string{
	...
	{ // code_hash
		"\"code_hash\"",
		"\"code_hash\" DESC",
		"\"code_hash\" ASC NULLS FIRST",
		"\"code_hash\" DESC NULLS LAST",
	},
	{ // created_at
		"\"created_at\"",
		"\"created_at\" DESC",
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	copy(r.UserID[:], rv[0])
	r.CodeHash = sl.Str(rv[1])
	r.CreatedAt = runtime.Timestamptz(rv[2])
	r.UsedAt = runtime.Nullable(rv[3], runtime.Timestamptz)
	return nil
}
...
// No write API: table recovery_codes has no primary key, so no statement can
